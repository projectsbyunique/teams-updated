...
namespace Teams {
    ...
    const teamData: {
        ...
        sockColor: number;
            ...
            { teamLocation: "Los Angeles (Chargers)", teamAbbreviation: "LAC", mainColor: 1, secondaryColor: 5, sockColor: 9 },
            { teamLocation: "Los Angeles (Rams)", teamAbbreviation: "LAR", mainColor: 8, secondaryColor: 5, sockColor: 5 },
